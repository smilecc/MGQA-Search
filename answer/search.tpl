...
<title><?php if (!empty($q)) echo "搜索：" . strip_tags($q) . " - "; ?>回答 搜索 - 萌娘问答</title>
<meta http-equiv="keywords" content="Fulltext Search Engine Answer xunsearch" />
<meta http-equiv="description" content="Fulltext Search for Answer, Powered by xunsearch/1.4.9 " />
...
<!-- search.tpl Answer 搜索模板 -->	
<body>
<div class="navbar">
  <div class="navbar-inner">
    <a class="brand" href="#">萌娘问答</a>
    <ul class="nav">
      <li><a href="http://wen.moegirl.org">返回站点</a></li>
      <li class="active"><a href="#">问题搜索</a></li>
      <li><a href="#">Link</a></li>
      <li><a href="#">Link</a></li>
    </ul>
  </div>
  ...
  <div class="row">
    ...
    <div class="span12">
      <form class="form-search" id="q-form" method="get">
        ...
        <div class="condition" id="q-options">
          <label class="radio inline"><input type="radio" name="f" value="question" <?php echo $f_question; ?> />问题</label>
			<label class="radio inline"><input type="radio" name="f" value="username" <?php echo $f_username; ?> />用户</label>
    ...
    <div class="span12">
      ...
      <dl class="result-list">
        ...
        <dt>
          <a target="_blank" href="http://wen.moegirl.org/index.php/Home/Question/<?php echo htmlspecialchars($doc->question_id); ?>/Answer/<?php echo htmlspecialchars($doc->id); ?>"><h4><?php echo $doc->rank(); ?>. <?php echo $search->highlight(htmlspecialchars($doc->question)); ?> <small>[<?php echo $doc->percent(); ?>%]</small></h4></a>          
        </dt>
        <dd>
          <p><?php echo $search->highlight(htmlspecialchars($doc->answer)); ?></p>
          <p class="text-error">
            <span><strong>作者:</strong><?php echo htmlspecialchars($doc->username); ?></span>
				<span><strong>发布时间:</strong><?php echo htmlspecialchars($doc->time); ?></span>
          </p>
        </dd>
        <?php endforeach; ?>
      </dl>
...
<footer>
  <div class="container">
    <p>(C)opyright 2014-2015 - 萌娘问答 问题搜索 - 页面处理总时间：<?php printf('%.4f', $total_cost); ?>秒<br>
      Powered by <a href="http://www.xunsearch.com/" target="_blank">xunsearch/1.4.9</a></p>
  </div>
</footer>
